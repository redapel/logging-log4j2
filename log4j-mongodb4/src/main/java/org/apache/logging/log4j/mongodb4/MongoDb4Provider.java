...
public final class MongoDb4Provider implements NoSqlProvider<MongoDb4Connection> {
    ...
    private MongoDb4Provider(final ConnectionString connectionString, final MongoClient mongoClient, final MongoDatabase mongoDatabase, final boolean isCapped,
